...
export const ACTUALIDAD_CATEGORIAS: any = {
...
export const ACTUALIDAD: any = [
    ...
    },
    {
        id: 5,
        fecha: "2022-04-27",
        titulo: "Un mapeo de actores",
        descripcion: "Investigación liderada por Perú que profundiza la relación entre la Trata de Personas, el contrabando de licores y el lavado del dinero. Resulta útil para comprender las dinámicas de la Triple Frontera y las economías ilegales que se alimentan entren si.",
        category: ACTUALIDAD_CATEGORIAS.articulos.identificador,
        url: "https://drive.google.com/file/d/1xyYvbjpZpClmtwJAyoIDPzD0p1sOMiUf/view?usp=sharing"
    },
    {
        id: 6,
        fecha: "2022-05-10",
        titulo: "Informe regional de DD.HH. Panamazonia",
        descripcion: "Situación de violación estructural de derechos humanos a los pueblos que habitan la Amazonía",
        category: ACTUALIDAD_CATEGORIAS.articulos.identificador,
        url: "https://drive.google.com/file/d/1SG6yLd13_9Y70iVn8gn30y3mVPEcWwJP/view?usp=sharing"
    }
]
